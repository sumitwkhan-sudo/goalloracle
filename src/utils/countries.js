// ISO-3166-1 alpha-2 country codes + display names + flag emoji.
// Used for the "Home country" picker on sign-up and leaderboard display.
...
const CODE_MAP = Object.fromEntries(COUNTRIES.map(c => [c.code, c]));
