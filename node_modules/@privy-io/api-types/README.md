...
[![NPM version](<https://img.shields.io/npm/v/@privy-io/api-types.svg?label=npm%20(stable)>)](https://npmjs.org/package/@privy-io/api-types) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/@privy-io/api-types)
...
```sh
npm install @privy-io/api-types
```
...
<!-- prettier-ignore -->
```js
import Privy from '@privy-io/api-types';
...
List methods in the Privy API are paginated.
...
```ts
import Privy from 'npm:@privy-io/api-types';
...
We are keen for your feedback; please open an [issue](https://www.github.com/privy-io/ts-types/issues) with questions, bugs, or suggestions.
