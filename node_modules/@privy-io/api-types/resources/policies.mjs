...
export class Policies extends APIResource {
    ...
    _deleteRule(ruleID, params, options) {
        const { policy_id, 'privy-authorization-signature': privyAuthorizationSignature, 'privy-request-expiry': privyRequestExpiry, } = params;
    ...
    _updateRule(ruleID, params, options) {
        const { policy_id, 'privy-authorization-signature': privyAuthorizationSignature, 'privy-request-expiry': privyRequestExpiry, ...body } = params;
