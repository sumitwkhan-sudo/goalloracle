...
export declare class CrossApp extends APIResource {
}
/**
 * The response for getting the list of cross-app connections.
 */
export interface CrossAppConnectionsResponse {
    connections: Array<CrossAppConnectionsResponse.Connection>;
}
export declare namespace CrossAppConnectionsResponse {
...
export declare namespace CrossApp {
    export { type CrossAppConnectionsResponse as CrossAppConnectionsResponse };
}
//# sourceMappingURL=cross-app.d.mts.map